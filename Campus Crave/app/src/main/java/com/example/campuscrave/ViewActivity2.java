...
public class ViewActivity2 extends AppCompatActivity {
    ...
    private void initializeComponents() {
        GridLayoutManager gridLayoutManager = new GridLayoutManager(ViewActivity2.this, 1);
        recyclerView.setLayoutManager(gridLayoutManager);

        AlertDialog.Builder builder = new AlertDialog.Builder(ViewActivity2.this);
        ...
        adapter = new MyAdapter(ViewActivity2.this, dataList);
        recyclerView.setAdapter(adapter);

        databaseReference = FirebaseDatabase.getInstance().getReference("Tomorrow's Food Items");
        dialog.show();
        ...
        adapter.setOnItemClickListener(new MyAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position) {
                ...
                Intent intent = new Intent(ViewActivity2.this, DetailsActivity2.class);
